...
>
> ✅ **Yun 2014 leído a texto completo (20-ago-2026):** no responde "qué parámetros importan más" (nadie de los seis lo hace, se abandona esa sub-pregunta sin bloquear nada). **Hallazgo más valioso:** el paper publica un toolbox de Matlab/Octave + su base de datos de 113 sujetos como Material Suplementario en ScienceDirect — si está accesible, es un tercer candidato más fuerte que reimplementar cualquier cosa. **Pendiente del usuario:** revisar si esa página tiene el enlace de descarga, en la misma sesión PUCP.
>
