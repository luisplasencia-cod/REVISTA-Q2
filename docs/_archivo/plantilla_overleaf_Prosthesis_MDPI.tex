% ============================================================
% ESQUELETO DE MANUSCRITO — Prosthesis (MDPI)
% Creado: 03-ago-2026 — DECISION FINAL de revista, tercera vuelta
% (reemplaza Bioengineering, que reemplazo a POI/SAGE, todo en la misma sesion)
%
...
%
% 4. APC confirmado: CHF 1600 (Prosthesis, 2025) -- dentro del tope de
%    USD 2500 dado por la universidad (confirmar si la cobertura del VRI
%    es total o parcial, ver docs/planificacion/revistas_candidatas_Q2.md
%    seccion "Convenio institucional PUCP").
%
% 5. Ajuste tematico verificado con precedente real (03-ago-2026): se
%    confirmo que "validar el instrumento/simulador de evaluacion" (no
%    la protesis en si) SI tiene cabida en esta revista -- ver
%    "Development and Comprehensive Evaluation of 3D-Printed Prosthetic
%    Feet: Modeling, Testing and a Pilot Gait Study", publicado en esta
%    misma revista (ISSN 2673-1592), que combina banco de pruebas +
%    estudio piloto de marcha igual que este proyecto. Confirmar de
%    todas formas la pagina de "Aims & Scope" (bloqueada para acceso
%    automatizado, no se pudo leer completa) antes de enviar.
%
% 6. Contenido: mismo que en los dos intentos anteriores (Bioengineering,
%    POI/SAGE -- quedan como referencia, no se borran), tomado de
%    docs/manuscrito/metodos_introduccion_borrador.md, ya sin
%    Kinovea/IMU de Alessandro/cita al paper de conferencia.
%
% 7. Estilo de referencias de MDPI: no se confirmo el comando exacto de
%    \bibliography en este ciclo -- revisar el template.tex real
%    descargado de Overleaf, que ya trae la configuracion correcta.
% ============================================================

\documentclass[prosthesis,article,submit,moreauthors]{Definitions/mdpi}
...
\funding{% [PENDIENTE -- confirmar con VRI si el apoyo de "Apoyos para la
Publicacion de Articulos de Alto Impacto en Acceso Abierto - Edicion
2026" cubre el 100% del APC de CHF 1600 o solo una parte]
...
%   - "Development and Comprehensive Evaluation of 3D-Printed Prosthetic
%     Feet: Modeling, Testing and a Pilot Gait Study" (Prosthesis, MDPI)
%     -- precedente directo de ajuste tematico, citar en Introduccion/Discusion
