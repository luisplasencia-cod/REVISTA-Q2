...
- [x] Tarea 5 (auditoría no-regresión Koopman) — hecho 27-ago-2026, coordinador directo (CSV byte-idénticos, PNG revertidos)
- [x] Tarea 6 (actualizar CIERRE docs) — hecho 27-ago-2026, coordinador directo
- [x] Tarea 7 (actualizar pipeline doc) — hecho 27-ago-2026, coordinador directo
